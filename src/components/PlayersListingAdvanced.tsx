import PlayersTableAdvanced from "./PlayersTableAdvanced.tsx";
...
const PlayersListingAdvanced = ({ players }: Props) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <PlayersTableAdvanced players={playersToShow} showOnlyCurrentTeam={showOnlyActive && showOnlyCurrentTeam} />
    </div>
  );
};

export default PlayersListingAdvanced;
